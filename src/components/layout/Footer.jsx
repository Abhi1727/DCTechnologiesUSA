        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-white text-primary-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center justify-center gap-2"
              >
                Subscribe Now
                <FaArrowRight />
              </button>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-primary-400 transition-colors flex items-start gap-3"
                >
